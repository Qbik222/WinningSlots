"use strict";
"use strict";function initAnchorScrolling(){$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click((function(e){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=$(this.hash);(n=n.length?n:$("[name="+this.hash.slice(1)+"]")).length&&(e.preventDefault(),$("html, body").animate({scrollTop:n.offset().top},1e3,(function(){var e=$(n);if(e.focus(),e.is(":focus"))return!1;e.attr("tabindex","-1"),e.focus()})))}}))}var video;function play(){video.play()}function end(){console.log("test"),$(".play-btn").show()}function initHamburger(){var e=$(".burger__button"),n=$(".header__nav"),t=$(".header__link");function o(){[e,n].forEach((function(e){return e.toggleClass("active")}))}e.click(o),t.click(o)}$(document).ready((function(){$(".slider").slick({slidesToShow:5,arrows:!1,autoplay:!0,autoplaySpeed:4e3,centerMode:!0,focusOnSelect:!0,responsive:[{breakpoint:1080,settings:{slidesToShow:3}},{breakpoint:430,settings:{slidesToShow:1}}]})})),window.onload=function(){video=document.getElementById("myplayer")},$(document).on("click",".play-btn",(function(){$(this).hide(),video.play()})),$(document).ready((function(){initHamburger(),initAnchorScrolling()}));
